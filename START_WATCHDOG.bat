...
echo [WATCHDOG] Monitoring: L:\zenml_project\import_inbox
echo [WATCHDOG] Log file: L:\zenml_project\logs\watchdog.log
echo.
...
REM Run watchdog
python L:\zenml_project\scripts\watchdog_ingest.py
