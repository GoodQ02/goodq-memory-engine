...
> Historical note: This completion report records a past organization pass. It
> is retained for provenance and is not the current source of truth for the docs
> tree. Use [../README.md](../README.md) and [README.md](README.md) first.
