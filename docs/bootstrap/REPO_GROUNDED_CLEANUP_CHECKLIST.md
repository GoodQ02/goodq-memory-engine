...
| Dead WSL toggle automation | [QUICK_START.md](../../wsl2_audio/QUICK_START.md), [README.md](../../wsl2_audio/README.md), [SCRIPT_REGISTRY.md](SCRIPT_REGISTRY.md) | The deleted toggle script is no longer part of the active repo surface, and operator docs now point to the canonical runtime selection model instead of pipeline-file edits. |
