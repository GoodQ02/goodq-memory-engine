...
### [__init__.py](../../agents/__init__.py)
- **Relative Path**: `agents/__init__.py`

### [__init__.py](../../agents/analysis/__init__.py)
...
### [config_healer.py](../../agents/config_healer.py)
...
### [control_agent.py](../../agents/control_agent.py)
...
### [__init__.py](../../agents/ingestion/__init__.py)
- **Relative Path**: `agents/ingestion/__init__.py`

### [__init__.py](../../agents/knowledge/__init__.py)
- **Relative Path**: `agents/knowledge/__init__.py`

### [llm_agent.py](../../agents/llm_agent.py)
...
### [mini_agent_client.py](../../agents/mini_agent_client.py)
...
### [recovery_db.py](../../agents/recovery_db.py)
...
### [recovery_strategies.py](../../agents/recovery_strategies.py)
...
### [self_healing_monitor.py](../../agents/self_healing_monitor.py)
...
### [control_recurrence.py](../../api/routes/control_recurrence.py)
...
### [ingest.py](../../api/routes/ingest.py)
...
### [run_index.py](../../api/routes/run_index.py)
- **Relative Path**: `api/routes/run_index.py`
- **Imports**: `fastapi.APIRouter`

### [run_summary.py](../../api/routes/run_summary.py)
- **Relative Path**: `api/routes/run_summary.py`
- **Imports**: `fastapi.APIRouter`

### [runtime.py](../../api/routes/runtime.py)
...
### [scenes.py](../../api/routes/scenes.py)
...
### [search.py](../../api/routes/search.py)
...
### [summary.py](../../api/routes/summary.py)
...
### [system.py](../../api/routes/system.py)
...
### [timeline.py](../../api/routes/timeline.py)
...
### [loaders.py](../../api/utils/loaders.py)
...
### [media_projection.py](../../api/utils/media_projection.py)
...
### [response_models.py](../../api/utils/response_models.py)
...
### [__init__.py](../../cli/__init__.py)
- **Relative Path**: `cli/__init__.py`

### [conduits_build.py](../../cli/conduits_build.py)
...
### [conduits_kg.py](../../cli/conduits_kg.py)
...
### [conduits_memory.py](../../cli/conduits_memory.py)
...
### [conduits_processing.py](../../cli/conduits_processing.py)
...
### [conduits_sensitive_sources.py](../../cli/conduits_sensitive_sources.py)
- **Relative Path**: `cli/conduits_sensitive_sources.py`
- **Functions**: `ensure_schema`
- **Imports**: `__future__.annotations`, `sqlite3`

### [conduits_store_stats.py](../../cli/conduits_store_stats.py)
...
### [control_recurrence_report.py](../../cli/control_recurrence_report.py)
...
### [goodq_doctor.py](../../cli/goodq_doctor.py)
...
### [list_inbox.py](../../cli/list_inbox.py)
...
### [media_refs.py](../../cli/media_refs.py)
...
### [monitor_ingestion.py](../../cli/monitor_ingestion.py)
...
### [observability_health.py](../../cli/observability_health.py)
...
### [observability_rollup.py](../../cli/observability_rollup.py)
...
### [persistent_store_alignment_audit.py](../../cli/persistent_store_alignment_audit.py)
...
### [print_config.py](../../cli/print_config.py)
...
### [run_ingestion.py](../../cli/run_ingestion.py)
...
### [step_runner.py](../../cli/step_runner.py)
...
### [system_status.py](../../cli/system_status.py)
...
### [test_ingestion.py](../../cli/test_ingestion.py)
...
### [ui_conduits_rollup.py](../../cli/ui_conduits_rollup.py)
...
### [gpu_manager.py](../../common/gpu_manager.py)
...
### [gpu_monitor.py](../../common/gpu_monitor.py)
...
### [progress_tracker.py](../../common/progress_tracker.py)
...
### [vram_allocator.py](../../common/vram_allocator.py)
...
### [python_paths.py](../../configs/python_paths.py)
...
### [control_recurrence_hygiene.py](../../lib/control_recurrence_hygiene.py)
...
### [control_recurrence_index.py](../../lib/control_recurrence_index.py)
...
### [control_recurrence_recommendations.py](../../lib/control_recurrence_recommendations.py)
...
### [control_recurrence_report.py](../../lib/control_recurrence_report.py)
...
### [control_recurrence_trend.py](../../lib/control_recurrence_trend.py)
...
### [goodq_logger.py](../../lib/goodq_logger.py)
...
### [kg_realtime_integration.py](../../lib/kg_realtime_integration.py)
...
### [knowledge_graph.py](../../lib/knowledge_graph.py)
...
### [llm_client.py](../../lib/llm_client.py)
...
### [mission_components.py](../../lib/mission_components.py)
...
### [model_lifecycle.py](../../lib/model_lifecycle.py)
...
### [persistent_store_alignment.py](../../lib/persistent_store_alignment.py)
...
### [run_narrative.py](../../lib/run_narrative.py)
...
### [run_summary.py](../../lib/run_summary.py)
...
### [summary_aggregator.py](../../lib/summary_aggregator.py)
...
### [__init__.py](../../pipelines/__init__.py)
- **Relative Path**: `pipelines/__init__.py`

### [direct_ingestion.py](../../pipelines/direct_ingestion.py)
...
### [__init__.py](../../retrieval/__init__.py)
...
### [multimodal_search.py](../../retrieval/multimodal_search.py)
...
### [narrative_summarizer.py](../../retrieval/narrative_summarizer.py)
...
### [temporal_reasoning.py](../../retrieval/temporal_reasoning.py)
...
### [__init__.py](../../steps/__init__.py)
- **Relative Path**: `steps/__init__.py`

## Subsystem: `steps/audio`

### [__init__.py](../../steps/audio/__init__.py)
...
### [__init__.py](../../steps/audio/segmentation/__init__.py)
...
### [phase0_normalization.py](../../steps/audio/segmentation/phase0_normalization.py)
...
### [phase1_vad_segmentation.py](../../steps/audio/segmentation/phase1_vad_segmentation.py)
...
### [phase2_pyannote.py](../../steps/audio/segmentation/phase2_pyannote.py)
...
### [phase3_chunk_builder.py](../../steps/audio/segmentation/phase3_chunk_builder.py)
...
### [phase5_video_scene_integration.py](../../steps/audio/segmentation/phase5_video_scene_integration.py)
...
### [__init__.py](../../steps/audio_diarize/__init__.py)
- **Relative Path**: `steps/audio_diarize/__init__.py`
- **Imports**: `step.audio_diarize`

### [step.py](../../steps/audio_diarize/step_wsl2.py)
...
### [step_wsl2.py](../../steps/audio_diarize/step_wsl2.py)
...
### [vad_preprocessor.py](../../steps/audio_diarize/vad_preprocessor.py)
...
### [step.py](../../steps/audio_embed_clap/step.py)
...
### [step.py](../bootstrap/INSTALL_BOOTSTRAP.md)
...
### [__init__.py](../../steps/audio_ingest_unified/__init__.py)
- **Relative Path**: `steps/audio_ingest_unified/__init__.py`

### [step_wsl2.py](../../steps/audio_ingest_unified/step_wsl2.py)
...
### [step.py](../../steps/audio_music_events/step.py)
...
### [step.py](../../steps/audio_speaker_merge/step.py)
...
### [step.py](../../steps/audio_time_hints/step.py)
...
### [__init__.py](../../steps/audio_transcribe/__init__.py)
- **Relative Path**: `steps/audio_transcribe/__init__.py`

### [step.py](../../steps/audio_transcribe/step.py)
...
### [step_wsl2.py](../../steps/audio_transcribe/step_wsl2.py)
...
### [__init__.py](../../steps/common/__init__.py)
- **Relative Path**: `steps/common/__init__.py`

### [atomic_io.py](../../steps/common/atomic_io.py)
...
### [audio_gpu_optimizer.py](../../steps/common/audio_gpu_optimizer.py)
...
### [canonical_sensitive_events.py](../../steps/common/canonical_sensitive_events.py)
...
### [conda_runner.py](../../steps/common/conda_runner.py)
...
### [config_loader.py](../../steps/common/config_loader.py)
...
### [config_redaction.py](../../steps/common/config_redaction.py)
...
### [faiss_utils.py](../../steps/common/faiss_utils.py)
...
### [gpu_config.py](../../steps/common/gpu_config.py)
...
### [gpu_guard.py](../../steps/common/gpu_guard.py)
- **Relative Path**: `steps/common/gpu_guard.py`
- **Classes**: `GPUGuard`
- **Imports**: `logging`, `os`, `time`, `torch`

### [lexicon.py](../../steps/common/lexicon.py)
...
### [llm_model_factory.py](../../steps/common/llm_model_factory.py)
...
### [memory_commit_events.py](../../steps/common/memory_commit_events.py)
...
### [memory_provenance.py](../../steps/common/memory_provenance.py)
...
### [memory_store.py](../../steps/common/memory_store.py)
...
### [memory_stores.py](../../steps/common/memory_stores.py)
...
### [platform_config.py](../../steps/common/platform_config.py)
- **Relative Path**: `steps/common/platform_config.py`
- **Classes**: `PlatformHelper`
- **Imports**: `os`, `pathlib.Path`, `sys`

### [profile_config.py](../../steps/common/profile_config.py)
...
### [progress_tracker.py](../../steps/common/progress_tracker.py)
...
### [qdrant_client.py](../../steps/common/qdrant_client.py)
...
### [quantization.py](../../steps/common/quantization.py)
...
### [retrieval_events.py](../../steps/common/retrieval_events.py)
...
### [retry.py](../../steps/common/retry.py)
...
### [safe_access.py](../../steps/common/safe_access.py)
...
### [sensitive_staging.py](../../steps/common/sensitive_staging.py)
...
### [step_logger.py](../../steps/common/step_logger.py)
...
### [tag_utils.py](../../steps/common/tag_utils.py)
...
### [tool_paths.py](../../steps/common/tool_paths.py)
...
### [__init__.py](../../steps/discover_sources/__init__.py)
- **Relative Path**: `steps/discover_sources/__init__.py`

### [step.py](../../steps/discover_sources/step.py)
...
### [__init__.py](../../steps/emotion_classify/__init__.py)
- **Relative Path**: `steps/emotion_classify/__init__.py`

### [step.py](../../steps/emotion_classify/step.py)
...
### [__init__.py](../../steps/face_embed/__init__.py)
- **Relative Path**: `steps/face_embed/__init__.py`

### [step.py](../../steps/face_embed/step.py)
...
### [__init__.py](../../steps/graph_builder/__init__.py)
- **Relative Path**: `steps/graph_builder/__init__.py`
- **Imports**: `graph_builder.build_knowledge_graph`

### [emotion_arc_analyzer.py](../../steps/graph_builder/emotion_arc_analyzer.py)
...
### [graph_builder.py](../../steps/graph_builder/graph_builder.py)
...
### [llm_enrichment.py](../../steps/graph_builder/llm_enrichment.py)
...
### [__init__.py](../../steps/health_auto_export/__init__.py)
- **Relative Path**: `steps/health_auto_export/__init__.py`

### [adapter.py](../../steps/health_auto_export/adapter.py)
...
### [normalizer.py](../../steps/health_auto_export/normalizer.py)
...
### [__init__.py](../../steps/home_assistant_status/__init__.py)
- **Relative Path**: `steps/home_assistant_status/__init__.py`

### [step.py](../../steps/home_assistant_status/step.py)
...
### [__init__.py](../../steps/image_caption/__init__.py)
- **Relative Path**: `steps/image_caption/__init__.py`

### [step.py](../../steps/image_caption/step.py)
...
### [step.py](../../steps/image_embed_clip/step.py)
...
### [step.py](../../steps/image_embed_dino/step.py)
...
### [step.py](../../steps/image_exif/step.py)
...
### [__init__.py](../../steps/image_ocr/__init__.py)
- **Relative Path**: `steps/image_ocr/__init__.py`

### [step.py](../../steps/image_ocr/step.py)
...
### [__init__.py](../../steps/llm_chat/__init__.py)
- **Relative Path**: `steps/llm_chat/__init__.py`

### [step.py](../../steps/llm_chat/step.py)
...
### [__init__.py](../../steps/object_detect/__init__.py)
- **Relative Path**: `steps/object_detect/__init__.py`

### [step.py](../../steps/object_detect/step.py)
...
### [step.py](../../steps/object_track_yolo/step.py)
...
### [step.py](../../steps/overview/step.py)
...
### [__init__.py](../../steps/pdf_text/__init__.py)
- **Relative Path**: `steps/pdf_text/__init__.py`

### [step.py](../../steps/pdf_text/step.py)
...
### [step.py](../../steps/sentiment/step.py)
...
### [step_fixed.py](../../steps/sentiment/step_fixed.py)
...
### [__init__.py](../../steps/system_metrics/__init__.py)
- **Relative Path**: `steps/system_metrics/__init__.py`

### [step.py](../../steps/system_metrics/step.py)
...
### [__init__.py](../../steps/tagger/__init__.py)
- **Relative Path**: `steps/tagger/__init__.py`

### [step.py](../../steps/tagger/step.py)
...
### [__init__.py](../../steps/text_embed/__init__.py)
- **Relative Path**: `steps/text_embed/__init__.py`

### [step.py](../../steps/text_embed/step.py)
...
### [__init__.py](../../steps/tts/__init__.py)
- **Relative Path**: `steps/tts/__init__.py`

### [step.py](../../steps/tts/step.py)
...
### [__init__.py](../../steps/video/__init__.py)
...
### [embedding_pooler.py](../../steps/video/embedding_pooler.py)
...
### [entity_extractor.py](../../steps/video/entity_extractor.py)
...
### [scene_embedder.py](../../steps/video/scene_embedder.py)
...
### [scene_frame_extractor.py](../../steps/video/scene_frame_extractor.py)
...
### [scene_visual_embeddings.py](../../steps/video/scene_visual_embeddings.py)
...
### [gpu_scene_detect.py](../../steps/video_scene_detect/gpu_scene_detect.py)
...
### [step.py](../../steps/video_scene_detect/step.py)
...
### [__init__.py](../../steps/video_summarizer/__init__.py)
- **Relative Path**: `steps/video_summarizer/__init__.py`
- **Imports**: `step.run_step`

### [step.py](../../steps/video_summarizer/step.py)
...
### [audio_bridge.py](../../wsl2_audio/audio_bridge.py)
...
### [audio_service.py](../../wsl2_audio/audio_service.py)
...
### [check_cuda.py](../../wsl2_audio/check_cuda.py)
...
### [fw_transcribe.py](../../wsl2_audio/fw_transcribe.py)
...
### [process_audio.py](../../wsl2_audio/process_audio.py)
