...
| Legacy ChromaDB / LangChain references | Compatibility residue | Legacy imports and naming remain in a few code paths and requirements, but the active retrieval truth is Qdrant-backed and should be documented that way. | `api/requirements.txt:3`; `api/requirements.txt:4`; `steps/common/memory_stores.py:15`; `api/main.py:347` |
