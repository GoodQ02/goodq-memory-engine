...
def _build_scene_meta(scene: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "objects": objects,
        "ocr_text": scene.get("ocr_text") or keyframe.get("ocr_text") or "",
        "music_events": scene.get("music_events") or audio.get("music_events") or [],
        "time_hints": scene.get("time_hints") or keyframe.get("time_hints") or audio.get("time_hints") or {},
        "metadata_time_hints": scene.get("metadata_time_hints") or audio.get("metadata_time_hints") or {},
