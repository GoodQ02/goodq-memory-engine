...
def main():
    ...
    lines.append("- docs/architecture/SCENE_MANIFEST_SPECIFICATION.md")
    ...
    lines.append("- docs/agent/CONTROL_AGENT.md")
    lines.append("- docs/architecture/PHASE6_MULTIMODAL_FUSION.md")
    lines.append("- docs/reference/CLI-REFERENCE.md")
