...
echo [INFO] Input: test_input\sample.mp4
echo [INFO] Workspace: logs\test_workspace
echo [INFO] Output: logs\test_results.json
echo.

python cli\run_ingestion.py --input-dir test_input --workspace logs\test_workspace --output logs\test_results.json --verbose --force
