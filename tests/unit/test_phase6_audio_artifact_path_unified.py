            ...
            "scenes": [
                {
                    ...
                    "audio": {
                        "path": "audio/scene_0000.wav",
                        "audio_meta": {"duration_sec": 2.0, "sample_rate": 16000},
...
def test_harmonizer_candidate_visible_people_uses_continuity_chain_confirmation(
    ...
    assert first_segment["candidate_visible_people"] == [
        {
            ...
            "evidence": [
                {
                    "segment_ids": ["scene_0000", "scene_0001", "scene_0002"],
                    "visible_segment_ids": ["scene_0000", "scene_0002"],
                    "mention_segment_ids": ["scene_0001"],
                    "mention_dominance_ratio": 1.0,
                    "dominance_ok_segment_ratio": 1.0,
                }
            ],
        }
    ]
    ...
    assert temporal_index["segments_with_candidate_visible_people"] == 1
    assert temporal_index["segments_with_conversation_owner"] == 0
    assert temporal_index["top_candidate_visible_people"] == [
        {"entity": "jerry", "type": "PERSON", "count": 1},
    ]
            ...
            "scenes": [
                ...
                },
                {
                    ...
                    "audio": {
                        ...
                        "speaker_transcript": [
                            {"start": 4.0, "end": 6.4, "text": "Jerry is coming.", "speaker": "SPEAKER_01"},
                            {"start": 6.4, "end": 8.0, "text": "Right, Jerry is downstairs.", "speaker": "SPEAKER_00"},
                        ],
                    },
                },
                {
    ...
    assert first_segment["candidate_visible_people"] == [
        {
            ...
            "evidence": [
                {
                    "segment_ids": ["scene_0000", "scene_0001", "scene_0002", "scene_0003"],
                    "visible_segment_ids": ["scene_0000", "scene_0003"],
                    "mention_segment_ids": ["scene_0001", "scene_0002"],
                    "mention_dominance_ratio": 0.6667,
                    "dominance_ok_segment_ratio": 0.75,
                }
            ],
        }
    ]
